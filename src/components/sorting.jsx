...
function Sort(){
    const {RandomArray,merge,quick,selection,insertion,bubble,setmerge,setinsertion,setquick,setselection,setbubble,arrayselemnts,options,setarraysize,activeindex,foundindex,range,Selection,time,pass,speed,setspeed,Insertion}=useContext(Helper);
    const chartdata={
